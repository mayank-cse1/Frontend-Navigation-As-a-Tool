      ...
      <div className=" mx-auto flex  justify-evenly items-center w-full ">
        ...
        <div className="flex justify-end items-start gap-x-14 md:gap-x-32 w-2/5">
          <div className="flex flex-col gap-3">
            <a href="https://github.com/mayank-cse1"><div className="hover:text-white hover:cursor-pointer">About Us</div></a>
            <div className="hover:text-white hover:cursor-pointer">Features</div>
            <a href="https://github.com/mayank-cse1"><div className="hover:text-white hover:cursor-pointer">Feedback</div></a>
            <a href="https://github.com/mayank-cse1"><div className="hover:text-white hover:cursor-pointer">Contact Us</div></a>
          </div>
          <div className="flex flex-col gap-3">
